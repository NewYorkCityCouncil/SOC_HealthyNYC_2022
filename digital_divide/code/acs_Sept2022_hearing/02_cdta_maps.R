...
source("digital_divide/code/acs_Sept2022_hearing/01_census_pull_cdta.R")
...
saveWidget(map, file="digital_divide/visual/map_broadband_cdta.html")

mapshot(map_bw, file = "digital_divide/visual/map_broadband_cdta.png", 
...
saveWidget(map, file="digital_divide/visual/map_poverty_cdta.html")

mapshot(map_bw, file = "digital_divide/visual/map_poverty_cdta.png", 
        vwidth = 900, vheight = 870)
